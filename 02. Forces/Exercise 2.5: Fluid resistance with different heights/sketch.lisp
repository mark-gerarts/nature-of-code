(defpackage :nature-of-code.forces.exercise-5
  (:export :start-sketch)
  (:use :cl :trivial-gamekit)
  (:import-from :cl-bodge :vector-length :normalize))
(in-package :nature-of-code.forces.exercise-5)
...
(defgame sketch ()
  ...
  (:viewport-title "Fluid resistance - different heights"))
  ...
  (let ((movers
          (loop for i upto 4
                collect (make-instance
                         'mover
                         :location (vec2 (* i 45) (- *height* (* i 45)))))))
    (setf (movers this) (make-array 5 :initial-contents movers))))
